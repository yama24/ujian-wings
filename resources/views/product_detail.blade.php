                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-warning">
                            ...
                            <h5 class="widget-user-desc">{{ $product->Product_Code }}</h5>
                        </div>
                        <div class="card-footer p-0">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <span class="nav-link">
                                        Price : <span class="float-right">{!! $product->Discount ? '<small><strike>Rp. ' . number_format($product->Price, 0, ',', '.') . ',-</strike></small>' : '' !!} Rp.
                                            {{ number_format($product->Price - ($product->Price * $product->Discount / 100), 0, ',', '.') }},-</span>
                                    </span>
                                </li>
                                <li class="nav-item">
                                    <span class="nav-link">
                                        Dimension : <span class="float-right">{{ $product->Dimension }}</span>
                                    </span>
                                </li>
                                <li class="nav-item">
                                    <span class="nav-link">
                                        Price Unit : <span class="float-right">{{ $product->Unit }}</span>
                                    </span>
                                </li>
                                <li class="nav-item">
                                    <span class="nav-link text-center">
                                        <button class="btn btn-block btn-success" id="{{ $product->id }}"
